...
var fE=_m('view',['class',2,'style',1],[],e,s,gg)
_(r,fE)
return r
}
...
var xAC=_m('fonts-icon',['bind:__l',79,'size',1,'type',2,'vueId',3],[],e,s,gg)
_(o0B,xAC)
var oBC=_n('text')
_r(oBC,'class',83,e,s,gg)
var fCC=_o(84,e,s,gg)
_(oBC,fCC)
_(o0B,oBC)
_(b9B,o0B)
_(r,b9B)
...
var oFC=_m('banner',['bind:__l',86,'vueId',1],[],e,s,gg)
_(hEC,oFC)
var cGC=_m('service-int',['bind:__l',88,'vueId',1],[],e,s,gg)
_(hEC,cGC)
var oHC=_m('notice',['bind:__l',90,'class',1,'data-ref',2,'noticeListData',3,'vueId',4],[],e,s,gg)
_(hEC,oHC)
var lIC=_m('category',['bind:__l',95,'categoryList',1,'vueId',2],[],e,s,gg)
_(hEC,lIC)
var aJC=_m('guide',['bind:__l',98,'vueId',1],[],e,s,gg)
_(hEC,aJC)
var tKC=_m('activity',['bind:__l',100,'vueId',1],[],e,s,gg)
_(hEC,tKC)
_(r,hEC)
return r
}
...
var bMC=_n('view')
_r(bMC,'class',102,e,s,gg)
var oNC=_n('view')
_r(oNC,'class',103,e,s,gg)
var xOC=_m('image',['class',104,'src',1],[],e,s,gg)
_(oNC,xOC)
var oPC=_n('text')
_r(oPC,'class',106,e,s,gg)
var fQC=_o(107,e,s,gg)
_(oPC,fQC)
_(oNC,oPC)
_(bMC,oNC)
var cRC=_n('view')
_r(cRC,'class',108,e,s,gg)
var hSC=_n('view')
_r(hSC,'class',109,e,s,gg)
var oTC=_n('view')
_r(oTC,'class',110,e,s,gg)
var cUC=_m('fonts-icon',['bind:__l',111,'size',1,'type',2,'vueId',3],[],e,s,gg)
_(oTC,cUC)
_(hSC,oTC)
var oVC=_m('input',['class',115,'maxlength',1,'placeholder',2,'type',3,'value',4],[],e,s,gg)
_(hSC,oVC)
_(cRC,hSC)
var lWC=_n('view')
_r(lWC,'class',120,e,s,gg)
var aXC=_n('view')
_r(aXC,'class',121,e,s,gg)
var tYC=_m('fonts-icon',['bind:__l',122,'size',1,'type',2,'vueId',3],[],e,s,gg)
_(aXC,tYC)
_(lWC,aXC)
var eZC=_m('input',['class',126,'placeholder',1,'type',2,'value',3],[],e,s,gg)
_(lWC,eZC)
var b1C=_n('view')
_r(b1C,'class',130,e,s,gg)
var o2C=_m('fonts-icon',['bind:__l',131,'bindtap',1,'data-event-opts',2,'size',3,'type',4,'vueId',5],[],e,s,gg)
_(b1C,o2C)
_(lWC,b1C)
_(cRC,lWC)
var x3C=_n('view')
_r(x3C,'class',137,e,s,gg)
_(cRC,x3C)
var o4C=_n('view')
_r(o4C,'class',138,e,s,gg)
_(cRC,o4C)
_(bMC,cRC)
_(r,bMC)
return r
