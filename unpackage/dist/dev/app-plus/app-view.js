...
Z([[7],[3,'temList']])
Z([3,'id'])
Z([[4],[[5],[[5],[1,'category_list']],[[2,'?:'],[[2,'&&'],[[2,'==='],[[7],[3,'idx']],[[2,'-'],[[6],[[7],[3,'temList']],[3,'length']],[1,1]]],[[2,'=='],[[2,'%'],[[6],[[7],[3,'temList']],[3,'length']],[1,2]],[1,1]]],[1,'upside_list_class'],[1,'']]]])
Z([[2,'+'],[[2,'+'],[1,'background-color:'],[[2,'?:'],[[2,'!'],[[6],[[7],[3,'item']],[3,'color']]],[1,'#999'],[[6],[[7],[3,'item']],[3,'color']]]],[1,';']])
Z([3,'category_text'])
Z([a,[[6],[[7],[3,'item']],[3,'templateName']]])
Z([[4],[[5],[[2,'?:'],[[2,'&&'],[[2,'==='],[[7],[3,'idx']],[[2,'-'],[[6],[[7],[3,'temList']],[3,'length']],[1,1]]],[[2,'=='],[[2,'%'],[[6],[[7],[3,'temList']],[3,'length']],[1,2]],[1,1]]],[1,'img'],[1,'category_backgorund']]]])
Z([3,'news_prople'])
Z([3,'news_title'])
Z([3,'新手引导'])
Z([3,'news_images'])
...
var x=['./components/page-link/page-link.wxml','./pages/index/index.wxml','./pages/index/notice/notice.wxml','./pages/login/login.wxml','./pages/market/market.wxml','./pages/my/my.wxml','./pages/news/news.wxml','./pages/trade/trade.wxml'];d_[x[0]]={}
...
var cF=_mz(z,'swiper',['autoplay',1,'circular',1,'class',2,'duration',3,'indicatorActiveColor',4,'indicatorColor',5,'indicatorDots',6,'interval',7],[],e,s,gg)
...
_(lK,aL)
_(fE,lK)
var xQ=_mz(z,'notice',['bind:__l',19,'class',1,'data-ref',2,'noticeListData',3,'vueId',4],[],e,s,gg)
_(fE,xQ)
var oR=_n('view')
...
var lY=_mz(z,'view',['class',29,'style',1],[],oV,hU,gg)
var aZ=_n('text')
_rz(z,aZ,'class',31,oV,hU,gg)
var t1=_oz(z,32,oV,hU,gg)
_(aZ,t1)
_(lY,aZ)
var e2=_n('view')
...
fS.wxXCkey=2
_2z(z,27,cT,e,s,gg,fS,'item','idx','id')
_(fE,oR)
var b3=_n('view')
...
var oNB=_mz(z,'view',['class',51,'style',1],[],fKB,oJB,gg)
var cOB=_n('view')
_rz(z,cOB,'class',53,fKB,oJB,gg)
var oPB=_mz(z,'text',['class',54,'style',1],[],fKB,oJB,gg)
var lQB=_oz(z,56,fKB,oJB,gg)
_(oPB,lQB)
_(cOB,oPB)
_(oNB,cOB)
var aRB=_n('view')
_rz(z,aRB,'class',57,fKB,oJB,gg)
var tSB=_mz(z,'view',['class',58,'style',1],[],fKB,oJB,gg)
var eTB=_oz(z,60,fKB,oJB,gg)
_(tSB,eTB)
_(aRB,tSB)
var bUB=_n('text')
...
_(oNB,aRB)
var xWB=_n('view')
_rz(z,xWB,'class',63,fKB,oJB,gg)
var oXB=_mz(z,'view',['class',64,'style',1],[],fKB,oJB,gg)
var fYB=_n('rich-text')
_rz(z,fYB,'nodes',66,fKB,oJB,gg)
_(oXB,fYB)
_(xWB,oXB)
var cZB=_mz(z,'view',['bindtap',67,'class',1,'data-event-opts',2,'style',3],[],fKB,oJB,gg)
var h1B=_oz(z,71,fKB,oJB,gg)
_(cZB,h1B)
_(xWB,cZB)
_(oNB,xWB)
_(cLB,oNB)
...
oHB.wxXCkey=2
_2z(z,49,xIB,e,s,gg,oHB,'item','idx','id')
_(o0,bGB)
_(fE,o0)
_(r,fE)
return r
...
var b9B=_mz(z,'transition',['bind:__l',6,'name',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var o0B=_n('view')
