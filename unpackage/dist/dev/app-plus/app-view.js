...
Z([3,'__e'])
Z([3,'tabbar_list'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'tabbarNavigator']],[[4],[[5],[[5],[1,'$0']],[[7],[3,'idx']]]]],[[4],[[5],[[4],[[5],[[4],[[5],[[5],[[5],[1,'data']],[1,'id']],[[6],[[7],[3,'item']],[3,'id']]]]]]]]]]]]]]]])
Z([3,'__l'])
Z([[2,'?:'],[[2,'=='],[[7],[3,'currentIndex']],[[7],[3,'idx']]],[1,'#2580EF'],[1,'#666']])
Z([[6],[[7],[3,'item']],[3,'sized']])
Z([[2,'?:'],[[2,'=='],[[7],[3,'currentIndex']],[[7],[3,'idx']]],[[6],[[7],[3,'item']],[3,'iconActive']],[[6],[[7],[3,'item']],[3,'icon']]])
Z([[2,'+'],[1,'1-'],[[7],[3,'idx']]])
Z([3,'tabbar_title'])
Z([[2,'+'],[[2,'+'],[1,'color:'],[[2,'?:'],[[2,'=='],[[7],[3,'currentIndex']],[[7],[3,'idx']]],[1,'#2580EF'],[1,'#999']]],[1,';']])
...
Z([[7],[3,'style']])
Z([3,'tabbar_top'])
Z([[2,'+'],[[2,'+'],[[2,'+'],[1,'height:'],[[2,'+'],[[7],[3,'customBarH']],[1,'px']]],[1,';']],[[2,'+'],[[2,'+'],[1,'padding-top:'],[[2,'+'],[[7],[3,'statusBarH']],[1,'px']]],[1,';']]])
Z([3,'tabbar_navigator'])
Z([[2,'+'],[[2,'+'],[1,'height:'],[[2,'+'],[[7],[3,'customBarH']],[1,'px']]],[1,';']])
Z([3,'startTab'])
Z([3,'clear:both;'])
Z([3,'header_outher'])
Z([3,'home_left'])
...
Z([3,'logo'])
Z([3,'logo_img'])
Z([[6],[[6],[[7],[3,'merchantInfo']],[3,'merchantSetting']],[3,'logoUrl']])
Z([3,'logo_txt'])
...
var aL=_mz(z,'fonts-icon',['bind:__l',10,'color',1,'size',2,'type',3,'vueId',4],[],oH,hG,gg)
_(lK,aL)
var tM=_mz(z,'view',['class',15,'style',1],[],oH,hG,gg)
var eN=_oz(z,17,oH,hG,gg)
_(tM,eN)
_(lK,tM)
_(cI,lK)
return cI
...
fE.wxXCkey=4
_2z(z,5,cF,e,s,gg,fE,'item','idx','id')
_(oB,oD)
_(r,oB)
return r
}
...
var cW=_n('slot')
_rz(z,cW,'name',11,e,s,gg)
_(oV,cW)
}
else{oV.wxVkey=2
var oX=_mz(z,'view',['bindtap',12,'class',1,'data-event-opts',2],[],e,s,gg)
...
var eFB=_mz(z,'header-view',['bind:__l',1,'isBack',1,'title',2,'vueId',3],[],e,s,gg)
_(o0,eFB)
var cAB=_v()
_(o0,cAB)
if(_oz(z,5,e,s,gg)){cAB.wxVkey=1
var bGB=_mz(z,'index-page',['bind:__l',6,'vueId',1],[],e,s,gg)
_(cAB,bGB)
}
var oBB=_v()
_(o0,oBB)
if(_oz(z,8,e,s,gg)){oBB.wxVkey=1
var oHB=_mz(z,'market-page',['bind:__l',9,'vueId',1],[],e,s,gg)
_(oBB,oHB)
}
var lCB=_v()
_(o0,lCB)
if(_oz(z,11,e,s,gg)){lCB.wxVkey=1
var xIB=_mz(z,'trade-page',['bind:__l',12,'vueId',1],[],e,s,gg)
_(lCB,xIB)
}
var aDB=_v()
_(o0,aDB)
if(_oz(z,14,e,s,gg)){aDB.wxVkey=1
var oJB=_mz(z,'news-page',['bind:__l',15,'vueId',1],[],e,s,gg)
_(aDB,oJB)
}
var tEB=_v()
_(o0,tEB)
if(_oz(z,17,e,s,gg)){tEB.wxVkey=1
var fKB=_mz(z,'my-page',['bind:__l',18,'vueId',1],[],e,s,gg)
_(tEB,fKB)
}
var cLB=_mz(z,'footer-view',['bind:__l',20,'bind:click',1,'current',2,'data-event-opts',3,'vueId',4],[],e,s,gg)
_(o0,cLB)
cAB.wxXCkey=1
cAB.wxXCkey=3
oBB.wxXCkey=1
...
var o2B=_mz(z,'view',['class',11,'style',1],[],fYB,oXB,gg)
var c3B=_n('view')
_rz(z,c3B,'class',13,fYB,oXB,gg)
var o4B=_mz(z,'text',['class',14,'style',1],[],fYB,oXB,gg)
var l5B=_oz(z,16,fYB,oXB,gg)
_(o4B,l5B)
_(c3B,o4B)
_(o2B,c3B)
var a6B=_n('view')
_rz(z,a6B,'class',17,fYB,oXB,gg)
var t7B=_mz(z,'view',['class',18,'style',1],[],fYB,oXB,gg)
var e8B=_oz(z,20,fYB,oXB,gg)
_(t7B,e8B)
_(a6B,t7B)
var b9B=_n('text')
_rz(z,b9B,'class',21,fYB,oXB,gg)
var o0B=_oz(z,22,fYB,oXB,gg)
_(b9B,o0B)
_(a6B,b9B)
_(o2B,a6B)
var xAC=_n('view')
_rz(z,xAC,'class',23,fYB,oXB,gg)
var oBC=_mz(z,'view',['class',24,'style',1],[],fYB,oXB,gg)
var fCC=_n('rich-text')
_rz(z,fCC,'nodes',26,fYB,oXB,gg)
_(oBC,fCC)
_(xAC,oBC)
var cDC=_mz(z,'view',['bindtap',27,'class',1,'data-event-opts',2,'style',3],[],fYB,oXB,gg)
var hEC=_oz(z,31,fYB,oXB,gg)
_(cDC,hEC)
_(xAC,cDC)
_(o2B,xAC)
_(cZB,o2B)
...
oVB.wxXCkey=2
_2z(z,9,xWB,e,s,gg,oVB,'item','idx','id')
_(oNB,bUB)
_(r,oNB)
return r
}
...
var z=gz$gwx_6()
var cGC=_mz(z,'swiper',['autoplay',0,'circular',1,'class',1,'duration',2,'indicatorActiveColor',3,'indicatorColor',4,'indicatorDots',5,'interval',6],[],e,s,gg)
...
var oVC=_oz(z,8,fQC,oPC,gg)
_(cUC,oVC)
_(oTC,cUC)
var lWC=_n('view')
_rz(z,lWC,'class',9,fQC,oPC,gg)
_(oTC,lWC)
_(cRC,oTC)
return cRC
}
oNC.wxXCkey=2
_2z(z,3,xOC,e,s,gg,oNC,'item','idx','id')
_(r,bMC)
return r
}
...
var o0C=_mz(z,'fonts-icon',['bind:__l',3,'type',1,'vueId',2],[],e,s,gg)
_(c9C,o0C)
_(o8C,c9C)
var lAD=_n('view')
_rz(z,lAD,'class',6,e,s,gg)
var aBD=_mz(z,'transition',['bind:__l',7,'name',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var tCD=_n('view')
...
var oHD=_mz(z,'fonts-icon',['bind:__l',2,'type',1,'vueId',2],[],e,s,gg)
_(xGD,oHD)
var fID=_n('text')
...
var cMD=_mz(z,'banner',['bind:__l',1,'vueId',1],[],e,s,gg)
_(oLD,cMD)
var oND=_mz(z,'service-int',['bind:__l',3,'vueId',1],[],e,s,gg)
_(oLD,oND)
var lOD=_mz(z,'notice',['bind:__l',5,'class',1,'data-ref',2,'noticeListData',3,'vueId',4],[],e,s,gg)
_(oLD,lOD)
var aPD=_mz(z,'category',['bind:__l',10,'categoryList',1,'vueId',2],[],e,s,gg)
_(oLD,aPD)
var tQD=_mz(z,'guide',['bind:__l',13,'vueId',1],[],e,s,gg)
_(oLD,tQD)
var eRD=_mz(z,'activity',['bind:__l',15,'vueId',1],[],e,s,gg)
_(oLD,eRD)
_(r,oLD)
return r
}
...
var oDE=_mz(z,'fonts-icon',['bind:__l',9,'color',1,'type',2,'vueId',3],[],e,s,gg)
_(hCE,oDE)
_(cBE,hCE)
var cEE=_mz(z,'input',['bindinput',13,'class',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6],[],e,s,gg)
_(cBE,cEE)
_(fAE,cBE)
var oFE=_n('view')
...
var tIE=_mz(z,'fonts-icon',['bind:__l',22,'color',1,'type',2,'vueId',3],[],e,s,gg)
_(aHE,tIE)
_(oFE,aHE)
var lGE=_v()
_(oFE,lGE)
if(_oz(z,26,e,s,gg)){lGE.wxVkey=1
var eJE=_mz(z,'input',['bindchange',27,'checked',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5],[],e,s,gg)
_(lGE,eJE)
}
else{lGE.wxVkey=2
var bKE=_v()
...
var oLE=_mz(z,'input',['bindchange',34,'checked',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5],[],e,s,gg)
_(bKE,oLE)
}
else{bKE.wxVkey=2
var xME=_mz(z,'input',['bindinput',40,'class',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(bKE,xME)
}
bKE.wxXCkey=1
}
...
var fOE=_mz(z,'fonts-icon',['bind:__l',47,'bindtap',1,'color',2,'data-event-opts',3,'type',4,'vueId',5],[],e,s,gg)
_(oNE,fOE)
_(oFE,oNE)
lGE.wxXCkey=1
_(fAE,oFE)
...
var hQE=_mz(z,'label',['bindtap',54,'class',1,'data-event-opts',2],[],e,s,gg)
var oRE=_n('view')
_rz(z,oRE,'class',57,e,s,gg)
var cSE=_mz(z,'checkbox',['checked',58,'color',1,'style',2,'value',3],[],e,s,gg)
_(oRE,cSE)
_(hQE,oRE)
var oTE=_n('view')
...
var bYE=_mz(z,'button',['bindtap',67,'class',1,'data-event-opts',2,'loading',3,'type',4],[],e,s,gg)
...
__wxAppCode__['components/header/header.wxss']=setCssToHead(["@charset \x22UTF-8\x22;\n.",[1],"tabbar_navigator { position: fixed; background: #2580EF; width: 100%; top: 0; left: 0; z-index: 101; text-align: center; -webkit-backface-visibility: hidden; backface-visibility: hidden; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-flex-wrap: wrap; -ms-flex-wrap: wrap; flex-wrap: wrap; }\n.",[1],"tabbar_navigator .",[1],"startTab { width: 100%; height: ",[0,30],"; }\n.",[1],"tabbar_navigator .",[1],"header_outher { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; width: 100%; padding: 0 ",[0,20],"; }\n.",[1],"tabbar_navigator .",[1],"header_outher .",[1],"home_left { width: 20%; -webkit-box-flex: 0; -webkit-flex: 0 0 20%; -ms-flex: 0 0 20%; flex: 0 0 20%; box-flex: 0 0 20%; position: relative; }\n.",[1],"tabbar_navigator .",[1],"header_outher .",[1],"home_left .",[1],"home_back_icon { position: relative; font-size: ",[0,30],"; line-height: ",[0,90],"; color: #ccc; }\n.",[1],"tabbar_navigator .",[1],"header_outher .",[1],"home_left .",[1],"home_back_icon .",[1],"icon_Back { width: ",[0,20],"; height: ",[0,28],"; display: block; position: absolute; top: ",[0,10],"; }\n.",[1],"tabbar_navigator .",[1],"header_outher .",[1],"home_center { width: 60%; -webkit-box-flex: 0; -webkit-flex: 0 0 60%; -ms-flex: 0 0 60%; flex: 0 0 60%; box-flex: 0 0 60%; font-size: ",[0,34],"; color: #eee; font-weight: 800; line-height: ",[0,90],"; }\n.",[1],"tabbar_navigator .",[1],"header_outher .",[1],"home_right { width: 20%; -webkit-box-flex: 0; -webkit-flex: 0 0 20%; -ms-flex: 0 0 20%; flex: 0 0 20%; box-flex: 0 0 20%; }\n.",[1],"tabbar_navigator .",[1],"header_outher .",[1],"home_right .",[1],"p { color: #ffffff; font-size: 14px; }\n",],undefined,{path:"./components/header/header.wxss"});    
