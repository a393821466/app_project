...
var oR=_mz(z,'view',['class',11,'style',1],[],bO,eN,gg)
var fS=_n('view')
_rz(z,fS,'class',13,bO,eN,gg)
var cT=_mz(z,'text',['class',14,'style',1],[],bO,eN,gg)
var hU=_oz(z,16,bO,eN,gg)
_(cT,hU)
_(fS,cT)
_(oR,fS)
var oV=_n('view')
_rz(z,oV,'class',17,bO,eN,gg)
var cW=_mz(z,'view',['class',18,'style',1],[],bO,eN,gg)
var oX=_oz(z,20,bO,eN,gg)
_(cW,oX)
_(oV,cW)
var lY=_n('text')
_rz(z,lY,'class',21,bO,eN,gg)
var aZ=_oz(z,22,bO,eN,gg)
_(lY,aZ)
_(oV,lY)
_(oR,oV)
var t1=_n('view')
_rz(z,t1,'class',23,bO,eN,gg)
var e2=_mz(z,'view',['class',24,'style',1],[],bO,eN,gg)
var b3=_n('rich-text')
_rz(z,b3,'nodes',26,bO,eN,gg)
_(e2,b3)
_(t1,e2)
var o4=_mz(z,'view',['bindtap',27,'class',1,'data-event-opts',2,'style',3],[],bO,eN,gg)
var x5=_oz(z,31,bO,eN,gg)
_(o4,x5)
_(t1,o4)
_(oR,t1)
_(oP,oR)
...
aL.wxXCkey=2
_2z(z,9,tM,e,s,gg,aL,'item','idx','id')
_(oD,lK)
_(r,oD)
return r
}
...
var z=gz$gwx_3()
var f7=_mz(z,'swiper',['autoplay',0,'circular',1,'class',1,'duration',2,'indicatorActiveColor',3,'indicatorColor',4,'indicatorDots',5,'interval',6],[],e,s,gg)
...
var oJB=_mz(z,'view',['class',5,'style',1],[],bGB,eFB,gg)
var fKB=_n('text')
_rz(z,fKB,'class',7,bGB,eFB,gg)
var cLB=_oz(z,8,bGB,eFB,gg)
_(fKB,cLB)
_(oJB,fKB)
var hMB=_n('view')
_rz(z,hMB,'class',9,bGB,eFB,gg)
_(oJB,hMB)
_(oHB,oJB)
return oHB
}
aDB.wxXCkey=2
_2z(z,3,tEB,e,s,gg,aDB,'item','idx','id')
_(r,lCB)
return r
}
...
var cZB=_mz(z,'fonts-icon',['bind:__l',3,'type',1,'vueId',2],[],e,s,gg)
_(fYB,cZB)
_(oXB,fYB)
var h1B=_n('view')
_rz(z,h1B,'class',6,e,s,gg)
var o2B=_mz(z,'transition',['bind:__l',7,'name',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var c3B=_n('view')
...
var e8B=_mz(z,'fonts-icon',['bind:__l',2,'type',1,'vueId',2],[],e,s,gg)
_(t7B,e8B)
var b9B=_n('text')
...
var fCC=_mz(z,'banner',['bind:__l',1,'vueId',1],[],e,s,gg)
_(oBC,fCC)
var cDC=_mz(z,'service-int',['bind:__l',3,'vueId',1],[],e,s,gg)
_(oBC,cDC)
var hEC=_mz(z,'notice',['bind:__l',5,'class',1,'data-ref',2,'noticeListData',3,'vueId',4],[],e,s,gg)
_(oBC,hEC)
var oFC=_mz(z,'category',['bind:__l',10,'categoryList',1,'vueId',2],[],e,s,gg)
_(oBC,oFC)
var cGC=_mz(z,'guide',['bind:__l',13,'vueId',1],[],e,s,gg)
_(oBC,cGC)
var oHC=_mz(z,'activity',['bind:__l',15,'vueId',1],[],e,s,gg)
_(oBC,oHC)
_(r,oBC)
return r
}
...
var cRC=_mz(z,'fonts-icon',['bind:__l',9,'color',1,'type',2,'vueId',3],[],e,s,gg)
_(fQC,cRC)
_(oPC,fQC)
var hSC=_mz(z,'input',['bindinput',13,'class',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'type',5,'value',6],[],e,s,gg)
_(oPC,hSC)
_(xOC,oPC)
var oTC=_n('view')
...
var lWC=_mz(z,'fonts-icon',['bind:__l',22,'color',1,'type',2,'vueId',3],[],e,s,gg)
_(oVC,lWC)
_(oTC,oVC)
var cUC=_v()
_(oTC,cUC)
if(_oz(z,26,e,s,gg)){cUC.wxVkey=1
var aXC=_mz(z,'input',['bindchange',27,'checked',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5],[],e,s,gg)
_(cUC,aXC)
}
else{cUC.wxVkey=2
var tYC=_v()
...
var eZC=_mz(z,'input',['bindchange',34,'checked',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5],[],e,s,gg)
_(tYC,eZC)
}
else{tYC.wxVkey=2
var b1C=_mz(z,'input',['bindinput',40,'class',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(tYC,b1C)
}
tYC.wxXCkey=1
}
...
var x3C=_mz(z,'fonts-icon',['bind:__l',47,'bindtap',1,'color',2,'data-event-opts',3,'type',4,'vueId',5],[],e,s,gg)
_(o2C,x3C)
_(oTC,o2C)
cUC.wxXCkey=1
_(xOC,oTC)
...
var f5C=_mz(z,'label',['bindtap',54,'class',1,'data-event-opts',2],[],e,s,gg)
var c6C=_n('view')
_rz(z,c6C,'class',57,e,s,gg)
var h7C=_mz(z,'checkbox',['checked',58,'color',1,'style',2,'value',3],[],e,s,gg)
_(c6C,h7C)
_(f5C,c6C)
var o8C=_n('view')
_rz(z,o8C,'class',62,e,s,gg)
var c9C=_oz(z,63,e,s,gg)
_(o8C,c9C)
_(f5C,o8C)
_(o4C,f5C)
var o0C=_n('view')
_rz(z,o0C,'class',64,e,s,gg)
var lAD=_oz(z,65,e,s,gg)
_(o0C,lAD)
_(o4C,o0C)
_(xOC,o4C)
var aBD=_n('view')
_rz(z,aBD,'class',66,e,s,gg)
var tCD=_mz(z,'button',['bindtap',67,'class',1,'data-event-opts',2,'loading',3,'type',4],[],e,s,gg)
var eDD=_oz(z,72,e,s,gg)
_(tCD,eDD)
_(aBD,tCD)
_(xOC,aBD)
_(aJC,xOC)
